...
@section('button')
<div class="btn-list">
    <a href="{{route('waba.templates',$device->id)}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="ti ti-chevron-left"></i>
        {{__('master.template.back_to')}}
    </a>
    <a href="{{route('waba.templates',$device->id)}}" class="btn btn-primary d-sm-none btn-icon" aria-label="{{__('master.template.back_to')}}">
        <i class="ti ti-chevron-left"></i>
    </a>
</div>
@endsection
