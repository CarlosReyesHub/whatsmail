...
<div class="row">
    <div class="col-xl-12">
        ...
        <form action="<?= route('stores.edit', $store->id); ?>" method="POST" class="card custom-card">
            @csrf
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12 mt-3">
                        ...
                        <select class="form-control provinces" name="province">
                            ...
                            <option value="<?= $province->id; ?>" @if(($store->district->city->province_id ?? '') == $province->id) selected @endif ><?= $province->name; ?></option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-6 col-sm-12 mt-3">
                    ...
                    <div class="col-lg-6 col-sm-12 mt-3">
                        ...
                        <select class="form-control districts" name="district">
                            <option value="<?= $store->district_id; ?>"><?= $store->district->name ?? ''; ?></option>
                        </select>
                    </div>
                    <div class="col-lg-6 col-sm-12 mt-3">
                    ...
                    <div class="col-lg-6 col-sm-12 mt-3">
                        ...
                        <input type="text" class="form-control" name="name" required value="<?= old('name', $store->name); ?>">
                    </div>
                    <div class="col-lg-6 col-sm-12 mt-3">
                        <label class="form-label">{{__('general.insert_wa')}}</label>
                        <input type="number" class="form-control" name="phone" value="<?= old('phone', $store->phone); ?>">
                    </div>
                    <div class="col-lg-6 col-sm-12 mt-3">
                    ...
                    <div class="col-lg-6 col-sm-12 mt-3">
                        ...
                        <select class="form-control" name="status" required>
                            <option value="yes" @if($store->status == 'yes') selected @endif>Non Aktif</option>
                            <option value="no" @if($store->status == 'no') selected @endif>Aktif</option>
                        </select>
                    </div>
                    <div class="col-12 mt-3">
                        <label class="form-label">{{__('customer.insert_address')}}</label>
                        <textarea class="form-control" name="address" required>{{old('address',$store->address)}}</textarea>
                    </div>
                </div>
            </div>
