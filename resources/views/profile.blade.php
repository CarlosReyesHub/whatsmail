...
<div class="row">
    ...
    <div class="col-lg-8 col-sm-12 mt-4">
        <form action="<?= route('profile.change'); ?>" enctype="multipart/form-data" method="POST" class="card custom-card">
            @csrf
    ...
    <div class="col-lg-4 col-sm-12 mt-4">
        <form action="<?= route('profile.password'); ?>" method="POST" class="card custom-card">
            @csrf
            <div class="card-header">
                <div class="card-title">
