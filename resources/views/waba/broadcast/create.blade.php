...
@section('button')
<div class="btn-list">
    <a href="{{route('waba.broadcast',$device->id)}}" class="btn btn-primary d-none d-sm-inline-block">
        <i class="ti ti-chevron-left"></i>
        {{__('blash.back_to')}}
    </a>
    <a href="{{route('waba.broadcast',$device->id)}}" class="btn btn-primary d-sm-none btn-icon" aria-label="{{__('blash.back_to')}}">
        <i class="ti ti-chevron-left"></i>
    </a>
</div>
@endsection
...
@section('scripts')
<script src="/js/app-broadcast.js"></script>
@endsection