...
{{< /md >}}
  ...
  <div class="col-md-8">
    {{< example >}}<img src="/assets/assets/img/bootstrap.svg" alt="Bootstrap" width="32" height="32">{{< /example >}}
  </div>
</div>
...
{{< /md >}}
  ...
  <div class="col-md-8">
    <div class="bd-example">
      <img src="/assets/assets/img/bootstrap.svg" alt="Bootstrap" width="32" height="32">
    </div>
{{< highlight html >}}
<!-- alt="..." on <img> element -->
<img src="/assets/assets/img/bootstrap.svg" alt="Bootstrap" ...>
{{< /highlight >}}
    <div class="bd-example">
